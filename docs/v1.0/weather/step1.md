...
- deferred：区域化天气建模（weather_zones），转 **Step 2**
- deferred：风险引擎修正，转 **Step 3**
- deferred：LLM `LlmRiskContext` 扩展，转 **Step 4**
- deferred：agent tool 注册，转 **Step 4**
